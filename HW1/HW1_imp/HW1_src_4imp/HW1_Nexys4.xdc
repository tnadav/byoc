...
set_property PACKAGE_PIN L6 [get_ports {sevenseg_out[4]}]
set_property PACKAGE_PIN M2 [get_ports {sevenseg_out[5]}]
set_property PACKAGE_PIN K3 [get_ports {sevenseg_out[6]}]

set_property PACKAGE_PIN M6 [get_ports {anodes_out[0]}]
set_property PACKAGE_PIN N6 [get_ports {anodes_out[1]}]
