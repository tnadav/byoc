...
set_property PACKAGE_PIN E3 [get_ports CK_100MHz]							
	set_property IOSTANDARD LVCMOS33 [get_ports CK_100MHz]
	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports CK_100MHz]
 
# ---- Danny ----
# Switches
#Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = SW0
set_property PACKAGE_PIN U9 [get_ports {switches_in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[0]}]
#Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {switches_in[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[1]}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {switches_in[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[2]}]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {switches_in[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[3]}]
#Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {switches_in[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[4]}]
#Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {switches_in[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[5]}]
#Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {switches_in[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[6]}]
#Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {switches_in[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {switches_in[7]}]

# next 8 switches - not used
...
set_property PACKAGE_PIN E16 [get_ports buttons_in[0]]						
	set_property IOSTANDARD LVCMOS33 [get_ports buttons_in[0]]
#Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports buttons_in[1]]						
	set_property IOSTANDARD LVCMOS33 [get_ports buttons_in[1]]
#Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports buttons_in[2]]						
...
set_property PACKAGE_PIN A3 [get_ports {VGA_red0}]				
...
set_property PACKAGE_PIN C5 [get_ports {VGA_red2}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_red2}]
#Bank = 35, Pin name = IO_L8P_T1_AD14P_35,					Sch name = VGA_R3
set_property PACKAGE_PIN A4 [get_ports {VGA_red3}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_red3}]
#Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports {VGA_blu0}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_blu0}]
#Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports {VGA_blu1}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_blu1}]
#Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports {VGA_blu2}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_blu2}]
#Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports {VGA_blu3}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_blu3}]
##Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports {VGA_grn0}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_grn0}]
#Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports {VGA_grn1}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_grn1}]
#Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports {VGA_grn2}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_grn2}]
#Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports {VGA_grn3}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {VGA_grn3}]
